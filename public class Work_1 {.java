public class Work_1 {
    public static void main(String[] args) {
        ...
        printWordNTimes("Al", 5);
        System.out.println(checkLeapYear(1222));
    }

    // 5.Написать метод, принимающий на вход два числа, и проверяющий что их
    ...
    // 7.Написать метод, которому в качестве параметра передается целое число.
